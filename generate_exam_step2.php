            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-sm" type="file" id="student_csv" name="student_csv" accept=".csv">
                        <div class="form-text small">First row will be skipped (header). File must contain 4 columns in order.</div>
                    </div>
                    ...
                    <?php foreach ($students as $i => $student): ?>
                        <tr>
                            <td><input type="text" class="form-control form-control-sm text-dark"
                                       ...
                                       value="<?php echo htmlspecialchars($student['student_ID']); ?>" required></td>
                            <td><input type="text" class="form-control form-control-sm text-dark"
                            ...
                            <td><input type="email" class="form-control form-control-sm text-dark"
                                       ...
                                       value="<?php echo htmlspecialchars($student['student_email']); ?>" required></td>
